...
`;let ke=class extends we{constructor(){super(...arguments),this.kind="primary",this.size="m",this.type="button",this.block=!1}get submits(){return"submit"===this.type}bindEvents(){this.on("click",(()=>{this.submits&&this.$form?.requestSubmit()}))}render(){return he.qy`
      <button
        type=${this.type}
        class="button"
      >
    ...
    `}};ke.formAssociated=!0,ke.styles=xe,(0,pe.Cg)([(0,Ae.MZ)({type:String,reflect:!0})],ke.prototype,"kind",void 0),(0,pe.Cg)([(0,Ae.MZ)({type:String,reflect:!0})],ke.prototype,"size",void 0),(0,pe.Cg)([(0,Ae.MZ)({type:String,reflect:!0})],ke.prototype,"type",void 0),(0,pe.Cg)([(0,Ae.MZ)({type:Boolean,reflect:!0})],ke.prototype,"block",void 0),ke=(0,pe.Cg)([(0,Ae.EM)("mon-button")],ke);const Ce=he.AH`
  :host {
    cursor: pointer;
    display: flex;
    gap: var(--mon-spacing);
