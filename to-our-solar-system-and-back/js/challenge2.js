...
var animations = {
  rotatedevice: 
    new ScrollMagic.Scene({triggerElement: '#rotatedevice', duration: '100%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
      .addController( getLandscapeController('#rotatedevice') )
  ,
  landing: {
    intro: function() {
  ...
  screen5: {
    ...
    intro: function() {
      this.call(function() {
        ...
        isMS ? m8.intro($('#screen5 .cover'), 'show', 'hidden') : $('#screen5 .container').animator().play('backdrop ~1s');
      });
          ...
          if (!scene.canLand()) {
            ...
            if (animations.screen5.liftoff.tried) {
              this.off().once('finished', function() {
                var niceTry = $('#screen5 .nice-try');
                isMS ? niceTry.removeClass('hidden') : m8.intro(niceTry, 'show', 'hidden');
                setTimeout(function() {
                  
                  $('#congrats3 .great-work').html('Nice try! Your rocket has not successfully landed.');
                  $('#congrats3 .learned').html('Thinking about the time, effort, technology, and money that it took to launch your rocket and bring it back to Earth, do you think it would be better if your rocket was a renewable or nonrenewable resource?');
                  $('#congrats3 .now').html('');
              ...
              this.off().once('finished', function() {
                var tryAgain = $('#screen5 .try-again');
                isMS ? tryAgain.removeClass('hidden') : m8.intro(tryAgain, 'show', 'hidden');
            ...
            this.off().once('finished', function() {
              ...
              $('#congrats3 .great-work').html('Super job on landing your rocket!');
              $('#congrats3 .learned').html('Your samples will be analyzed by many other scientists. You might even have a new substance named after you!');
              $('#congrats3 .now').html('Thinking about the time, effort, technology, and money that it took to launch your rocket and bring it back to Earth, do you think it would be better if your rocket was a renewable or nonrenewable resource?');
    ...
    new ScrollMagic.Scene({triggerElement: '#screen5_buffer', duration: '100%'})
      ...
      .addController( getSceneController({
        ...
        onRegister: function() {
          ...
          this.cert = this.container.find('.cert');
        },
        onBoot: function() {
          this.cert.click(function() {
            window.open('images/CertificateofCompletion.pdf', '_blank');
          });
...
var prepareLand = function() {
  ...
  isMS ? tryAgain.addClass('hidden') : m8.outro(tryAgain, 'hide', 'hidden');
  m8.intro($('#screen5 .land-instructions, #screen5 .land-instructions [data-show]'), 'show', 'hidden');
};
