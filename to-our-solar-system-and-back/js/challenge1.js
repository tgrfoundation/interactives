...
var scenes = {
  ...
  ,
  screen1_init:
    new ScrollMagic.Scene({triggerElement: '#screen1_buffer', duration: '200%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
  ...
  ,
  screen1: 
    new ScrollMagic.Scene({triggerElement: '#screen1_trigger', duration: '100%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
      .startDuring( animations.screen1.startDuring )
  ,
  screen2_init:
    new ScrollMagic.Scene({triggerElement: '#screen2_buffer', duration: '300%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
  ...
  ,
  screen2: 
    new ScrollMagic.Scene({triggerElement: '#screen2_trigger', duration: '100%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
  ...
  ,
  screen2b_init:
    new ScrollMagic.Scene({triggerElement: '#screen2b_buffer', duration: '300%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
  ...
  ,
  screen2b: 
    new ScrollMagic.Scene({triggerElement: '#screen2b_trigger', duration: '100%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
  ,
  screen3_init:
    new ScrollMagic.Scene({triggerElement: '#screen3_buffer', duration: '300%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
  ...
  ,
  screen3: 
    new ScrollMagic.Scene({triggerElement: '#screen3_trigger', duration: '100%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
      .addControllerLazy( getGatedController() )
      .addControllerLazy( getDialogController({
      ...
      .addControllerLazy( getSlideshowController({
        ...
        onShow: function(slideName) {
          if (slideName !== '0') {
            var question = this.scene['question' + slideName];
            if (!question || question.tryCount < question.tries) {
  ...
  ,
  large_scroll:
    new ScrollMagic.Scene({triggerElement: '#screen4_buffer', offset: '50%', duration: function() {
  ...
  ,
  screen4_init:
    new ScrollMagic.Scene({triggerElement: '#screen4_buffer', duration: '300%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
  ...
  ,
  screen4: 
    new ScrollMagic.Scene({triggerElement: '#screen4_trigger', duration: '100%'})
      .addTo(controller)
      .setBackwards(BACKWARDS)
